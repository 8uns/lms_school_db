...
Router::add('GET', '/guru/bank-soal/subject/([0-9]*)/class/([0-9]*)/ay/([0-9]*)', GuruBanksoalController::class, 'getQuestionsByContext', [AuthMiddleware::class,  RoleMiddleware::class . ':Guru']); // menu manage guru
